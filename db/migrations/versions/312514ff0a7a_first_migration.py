...
Revision ID: 312514ff0a7a
Revises:
Create Date: 2022-01-14 06:14:56.857808
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column("stable", sa.Boolean(), server_default="0", nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("status", sa.VARCHAR(length=30), server_default="0", nullable=False),
